# `MUMPS_seq_jll.jl` (v500.700.300+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c10f3d62b81404cf0dee1fd5f9bfc14f80e559a4/M/MUMPS/MUMPS_seq@5/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
