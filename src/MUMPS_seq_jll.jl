...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MUMPS_seq_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d7ed1dd3-d0ae-5e8e-bfb4-87a502085b8d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MUMPS_seq", artifacts_toml) for e in artifacts["MUMPS_seq"]]
...
if best_platform === nothing
    @debug("Unable to load MUMPS_seq; unsupported platform $(triplet(platform_key_abi()))")
else
