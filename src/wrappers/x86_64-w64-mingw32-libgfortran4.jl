...
export libcmumps, libsmumps, libzmumps, libdmumps
...
const libcmumps_splitpath = ["bin", "libcmumps.dll"]
...
const libcmumps = "libcmumps.dll"


# Relative path to `libsmumps`
const libsmumps_splitpath = ["bin", "libsmumps.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libsmumps = "libsmumps.dll"


# Relative path to `libzmumps`
const libzmumps_splitpath = ["bin", "libzmumps.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libzmumps = "libzmumps.dll"


# Relative path to `libdmumps`
const libdmumps_splitpath = ["bin", "libdmumps.dll"]
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (METIS_jll.PATH_list, OpenBLAS_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (METIS_jll.LIBPATH_list, OpenBLAS_jll.LIBPATH_list,))
